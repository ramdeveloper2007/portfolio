...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4 text-center bg-surface text-content relative overflow-hidden">
      <div className="absolute inset-0 studio-grid opacity-50 pointer-events-none" />
      <div className="relative z-10 max-w-md">
        <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-cyan-500/10 text-accent border border-cyan-500/20">
