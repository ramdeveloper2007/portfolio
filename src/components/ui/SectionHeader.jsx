...
export function SectionHeader({ label, title, description, align = 'center', headingId }) {
  ...
  return (
    <FadeIn data-motion-item className={`mb-10 md:mb-14 flex flex-col gap-4 ${alignment}`}>
      {label && (
      ...
      <h2 data-motion-heading id={headingId} className="max-w-3xl font-display text-3xl font-extrabold leading-tight tracking-tight text-content sm:text-4xl md:text-5xl">
        {title}
      </h2>
      {description && (
